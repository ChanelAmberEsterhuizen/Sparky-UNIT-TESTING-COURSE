...
namespace Bongo.Web
{
    ...
    public class RoomBookingControllerTests
    {
        ...
        [Test]
        public void IndexPage_CallR_VerifyGetAllInvoked()
        {
        ...
        {
            _studyRoomBookingService.Setup(x => x.BookStudyRoom(It.IsAny<StudyRoomBooking>())).Returns(
        ...
        {
            _studyRoomBookingService.Setup(x => x.BookStudyRoom(It.IsAny<StudyRoomBooking>())).Returns(
                (StudyRoomBooking booking) => new StudyRoomBookingResult() 
                {
            ...
            Assert.AreEqual("sa", actionResult.RouteValues["FirstName"]);
