...
namespace Bongo.Core
{
    ...
    public class StudyRoomBookingServiceTests
    {
        ...
        [Test]
        public void StudyRoomBooking_SaveBookingWithAvailableRoom_ReturnsResultWithAllVallues()
        {
        ...
        [Test]
        public void StudyRoomBookingResultCheck_InputRequest_ValueMatchInRessult()
        {
        ...
        public StudyRoomBookingCode ResultCodeSuccess_RoomAvailibility_ResturnsSuccessResultCode(bool roomAvailibility)
        {
            if (!roomAvailibility)
            {
        ...
        [TestCase(55, true )]
        public void StudyRoomBooking_BookRoomWithAvailibilty_ReturnsBookingId(int expectedBookingId, bool roomAvailibilty)
        {
            if (!roomAvailibilty)
            {
                _availableStudyRoom.Clear();
        ...
        [Test]
        public void BookNotInvoked_SaveBookingWithoutAvaqilableRoom_BookMethodNotInvoked
            ()
        {   
               _availableStudyRoom.Clear();
            var result = _bookingService.BookStudyRoom(_request);
